"""
Django settings for dazzm_47955 project.
...
WSGI_APPLICATION = 'dazzm_47955.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dazzm_47955 API",
    "DESCRIPTION": "API documentation for dazzm_47955 App",
    "VERSION": "v1",
}
